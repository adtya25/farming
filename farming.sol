...
contract Nama is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Nama";
    string private _symbol = "$Symbol";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x1f45bCEcBF10F233D2Afb35D9f1B7eF57aBfE7a9); // Marketing Address
